...
#'
#' @description
#' This function is a very parallel version of [benchmark] using
...
#' from a vector of dataset IDs easily with `tasks = lapply(data.ids,
#' function(x) convertOMLDataSetToMlr(getOMLDataSet(x)))`.
